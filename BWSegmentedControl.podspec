#
#  Be sure to run `pod spec lint BWSegmentedControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of BWSegmentedControl in Markdown format.
  ...
  # Or just: s.author    = "Mendy Krinsky"
  # s.authors            = { "Mendy Krinsky" => "mendyk3@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Mendy Krinsky"
  ...
  s.source_files  = "SegmentedControl/*.{h,m}"

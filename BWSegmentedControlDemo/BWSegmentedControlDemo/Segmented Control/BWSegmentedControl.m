...
- (void)layoutSubviews{
    ...
    /* Create top rect (Eventuallly)
     ...
     topLayer.cornerRadius = self.topRectCornerRadius;
...
- (CGFloat)itemWidth{
    return CGRectGetWidth(self.topRect) / [self.items count];
}
...
- (CGRect)topRect{
    return CGRectMake(CGRectGetMinX(self.bounds),
                      CGRectGetMinY(self.bounds),
